                    ...
                    "columns": [{
                        ...
                        },
                        {
                            ...
                            "mRender": function(data, type, row) {
                                ...
                                btn = btn + `<button onclick='ParamFunc.editdata("` + row.id_Jurusan + `")' class='btn  btn-primary' type='button'><i class='la la-edit'></i></button>`;
                                btn = btn + `<button onClick='ParamFunc.deletedata("` + row.id_Jurusan + `")' class='btn  btn-danger tombolhapus' type='button'><i class='la la-trash'></i></button>`;
                                btn = btn + `</div>`;
                                return btn;
                            }
                        }
